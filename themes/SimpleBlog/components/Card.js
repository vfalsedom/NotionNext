const Card = ({ children, headerSlot, className }) => {
  return <div className={className}>
    ...
    <section className="card shadow-md hover:shadow-md dark:text-gray-300 border dark:border-black rounded-lg lg:p-6 p-4 bg-white dark:bg-hexo-black-gray lg:duration-100">
        {children}
    </section>
  </div>
}
