...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'SimpleBlog', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'N2F7', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'This is my wiki', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.n2f7.site', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/vfalsedom', // 你的github个人主页 例如 https://github.com/tangly1024
